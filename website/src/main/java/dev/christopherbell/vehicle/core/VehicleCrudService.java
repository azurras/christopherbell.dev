...
/**
 * Owns vehicle CRUD behavior so storage rules stay separate from VIN-only
 * creation and external data collection.
 */
...
public class VehicleCrudService {
  ...
  /**
   * Creates a new vehicle document from full vehicle data.
   */
  ...
  /**
   * Updates an existing vehicle by id and preserves audit fields.
   */
