...
Owns public profile and self-account read behavior.
...
Update this README when public profile fields, self-account reads, or follow
state display behavior changes.
