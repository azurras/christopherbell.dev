...
class PostgresqlPersistenceBoundaryRulesTest {
  private static final Map<String, String> CONTRACT_GROUP_BY_ADAPTER = Map.ofEntries(
      ...
      entry("dev.christopherbell.configuration.persistence.PostgresApplicationLeaseStore", "application-lease"),
      ...
      entry("dev.christopherbell.music.catalog.PostgresMusicCatalogQueryRepository", "music-catalog"),
      entry("dev.christopherbell.music.catalog.PostgresMusicTrackRepository", "music-track"),
      entry("dev.christopherbell.music.library.PostgresMusicPlaylistRepository", "music-playlist"),
      entry("dev.christopherbell.music.metadata.PostgresMusicMetadataEditRepository", "music-metadata"),
      entry("dev.christopherbell.music.radio.PostgresMusicRadioHistoryRepository", "music-radio-history"),
      entry("dev.christopherbell.music.radio.PostgresMusicRuntimeStateRepository", "music-runtime"),
      entry("dev.christopherbell.music.security.PostgresMusicAccessAttemptRepository", "music-access-audit"),
      ...
      entry("dev.christopherbell.sharedfolder.audit.PostgresSharedFolderAuditRepository", "shared-folder-audit"),
      entry("dev.christopherbell.sharedfolder.maintenance.PostgresSharedFolderMaintenanceLeaseStore", "shared-folder-lease"),
      entry("dev.christopherbell.sharedfolder.media.PostgresMediaJobRepository", "shared-folder-media"),
